...
ActiveRecord::Schema[7.1].define(version: 2024_09_24_123512) do
  create_table "access_roles", charset: "utf8mb3", force: :cascade do |t|
    t.integer "name"
    t.string "emp_type"
    t.bigint "emp_id"
  ...
  create_table "dev_teams", charset: "utf8mb3", force: :cascade do |t|
  ...
  create_table "emp_details", charset: "utf8mb3", force: :cascade do |t|
  ...
  create_table "emps", charset: "utf8mb3", force: :cascade do |t|
    t.string "name"
    t.date "dob"
    t.string "mobile"
    t.string "email"
  ...
  create_table "marketting_teams", charset: "utf8mb3", force: :cascade do |t|
    t.string "team_list_type"
    t.bigint "team_list_id"
    t.string "emp_type"
    t.bigint "emp_id"
  ...
  create_table "payslips", charset: "utf8mb3", force: :cascade do |t|
    t.bigint "user_id"
    t.bigint "emp_id"
  ...
  create_table "team_lists", charset: "utf8mb3", force: :cascade do |t|
    t.integer "name"
    t.string "team_type"
    t.bigint "team_id"
    t.datetime "created_at", null: false
  ...
  create_table "time_values", charset: "utf8mb3", force: :cascade do |t|
    t.time "time"
  ...
  create_table "user_break_logs", charset: "utf8mb3", force: :cascade do |t|
    t.datetime "break_in"
  ...
  create_table "user_check_logs", charset: "utf8mb3", force: :cascade do |t|
    t.datetime "check_in"
  ...
  create_table "user_logs", charset: "utf8mb3", force: :cascade do |t|
    t.string "user_type"
    t.bigint "user_id"
    t.datetime "check_in"
    t.datetime "check_out"
