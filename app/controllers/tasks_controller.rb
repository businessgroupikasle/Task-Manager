class TasksController < ApplicationController
  ...
  # def update_user_log
  #   user_log = UserLog.find_or_create_by(user_id: 7)
  #   user_log.update(
  #     check_in: Time.at(params[:user_log][:check_in].to_i / 1000),
  #     check_out: Time.at(params[:user_log][:check_out].to_i / 1000),
  #     active_time: params[:user_log][:active_time],
  #     break_time: params[:user_log][:break_time]
  #   )
  #   if user_log.save
  #     render json: { message: 'User log updated successfully' }, status: :ok
  #   else
  #     render json: { error: 'Failed to update user log' }, status: :unprocessable_entity
  #   end
  # end

  # def update_user_log
  #   user_log = UserLog.find_or_create_by(user_id: 7)
  #   user_log.check_in = params[:check_in]
  #   user_log.check_out = params[:check_out]
  #   user_log.active_time = params[:active_time]
  #   user_log.break_time = params[:break_time]
  #   user_log.save!
  ...
  #   user_log.assign_attributes(user_log_params)
    
  #   if user_log.save
  #     redirect_to some_path, notice: 'User log updated successfully'
  #   else
  #     redirect_to some_path, alert: 'Failed to update user log'
  #   end
  # end
